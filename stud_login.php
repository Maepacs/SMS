        ...
        if ($stmt->num_rows > 0) {
            ...
            if (password_verify($password, $db_password_hash)) {
                ...
                if ($role == 'student') {
                 ...
                 // Redirect to admin or teacher login panel
                 if ($role == 'admin') {
                    ?>
                    <script>alert("You are not a student, redirecting to admin login page."); window.location.href = "admin_login.php";</script>
                    <?php
                } elseif ($role == 'teacher') {
                    ?>
                    <script>alert("You are not a student, redirecting to teacher login page."); window.location.href = "faculty_login.php";</script>
                    <?php
                } else {
                    ?>
