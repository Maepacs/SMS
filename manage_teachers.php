...
$query = "SELECT id, username, email, role, created_at, updated_at FROM users WHERE role='teacher'";
...
<body>
    ...
    <div class="content">
        ...
        <!-- Register button -->
        <a href="#" id="registerBtn" class="register-btn">Register New Teacher</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            if (status) {
                if (status === 'success') {
                    popupMessage.text('Teacher credentials have been successfully updated!');
                    popupMessage.addClass('success show');
                } else if (status === 'error') {
                    popupMessage.text('Error updating teacher credentials. Please try again.');
